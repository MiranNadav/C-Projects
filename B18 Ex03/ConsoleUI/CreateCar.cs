...
namespace Ex03.ConsoleUI
{
    class CreateCar
    {
        ...
        private void paintCar()
        {
            ...
            m_NewCar.Color = (Car.eCarColor)ValidateUserInput.InputIsInRangeOfEnum(typeof(Car.eCarColor));
        }

        private void installDoors()
        {
            Console.WriteLine("Please choose the number of Doors: ");
            m_NewCar.NumberOfDoors = (Car.eNumberOfDoors)ValidateUserInput.InputIsInRangeOfEnum(typeof(Car.eNumberOfDoors));
        }
    }
}
